...
WEAK int halide_perfctr_pipeline_start(void *user_context,
                                    const char *pipeline_name,
                                    int num_funcs,
                                    int num_loops,
                                    const uint64_t *func_names,
...
WEAK void halide_perfctr_stack_peak_update(void *user_context, void *pipeline_state, uint64_t *f_values);
WEAK void halide_perfctr_memory_allocate(void *user_context, void *pipeline_state, int func_id, uint64_t incr);
WEAK void halide_perfctr_memory_free(void *user_context, void *pipeline_state, int func_id, uint64_t decr);
